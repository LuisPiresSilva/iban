package net.luispiressilva.iban.ui.widgets.afm
...
class FragmentCall private constructor() : Builder() {
    ...
    companion object {
        ...
        /*fun printFragments(fragmentManager: FragmentManager?) {
            val list = fragmentManager?.fragments
            list?.let {
                it.forEach {
                    Log.e("FRAGMENTS", "$it ${it.tag}")
                }
            }
            Log.e("FRAGMENTS", "Count: ${fragmentManager?.backStackEntryCount}")
            Log.e("FRAGMENTS", "----------------")
        }*/
    }
